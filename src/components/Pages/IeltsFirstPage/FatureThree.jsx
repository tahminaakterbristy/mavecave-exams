  ...
  return (
    <div className="bg-gray-100 p-6 rounded-lg max-w-4xl mx-auto my-8 font-sans">
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <h2 className="text-xl font-bold text-gray-800 mb-4">৩. ২০২৩ সালে বাংলাদেশে General Training IELTS পরীক্ষার তারিখসমূহ</h2>
        <p className="text-gray-700 mb-4">
          আপনার যদি ইংরেজি ভাষাভাষী কোনো দেশে কাজের বা প্রশিক্ষণের কাজে যাওয়ার অভিপ্রায় থাকে, তাহলে IELTS General Training পরীক্ষাটি আপনার জন্য উপযুক্ত। এই পরীক্ষাটি আপনার সাধারণ জীবন ও কাজ সম্পর্কে আপনার জ্ঞান পরীক্ষা করে।
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <div className="bg-blue-50 p-4 rounded-lg mb-6">
          <ul className="list-disc pl-6 text-gray-700 text-sm space-y-2">
            <li>IELTS জেনারেল ট্রেনিং পরীক্ষা শুধুমাত্র মাসের তিন দিনই হয় (প্রচলিত চতুর্থ দিন বাদ)। একটি নির্দিষ্ট পরীক্ষার দিনে তিনটি ভাগ করা হয়, যার সময় আপনি আপনার সুবিধামত বেছে নিতে পারেন।</li>
        ...
        <h3 className="text-lg font-bold text-gray-800 mb-4">জেনারেল ট্রেনিং পরীক্ষার জন্য IELTS পরীক্ষার তারিখ: শহরভিত্তিক তালিকা</h3>
